"""Config flow for Oasira Business integration."""
import logging
...
class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input: dict | None = None) -> FlowResult:
        ...
        # Show the form
        info_text = "New Here? Visit https://my.oasira.ai to create an account."
    ...
    async def async_step_manual_entry(self, user_input: dict | None = None) -> FlowResult:
        ...
        info_text = (
            ...
            "Please enter them manually. You can find these at https://my.oasira.ai"
        )
