...
class AIDataTaskEntity(ai_task.AITaskEntity):
    ...
    def __init__(self, entry: ConfigEntry, hass: HomeAssistant, client: Client) -> None:
        ...
        self._entry = entry
        self._hass = hass
        self._attr_name = NAME +" AI Task"
        self._attr_unique_id = f"{NAME}_ai_task_{entry.entry_id}"
...
class AIImageTaskEntity(ai_task.AITaskEntity):
    ...
    def __init__(self, entry: ConfigEntry, hass: HomeAssistant, client: Client) -> None:
        ...
        self._attr_name = NAME +" AI Image Task"
        self._attr_unique_id = f"{NAME}_ai_image task_{entry.entry_id}"
    ...
    async def _async_generate_image(
        ...
        model = self._hass.data[NAME]["ai_model"]
